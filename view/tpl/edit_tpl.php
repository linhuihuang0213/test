<!--中间内容 start-->
  <div id="content">
    ...
    <div class="left" id="c_left">
      <div class="s_tuijian">
        <h2>修改<span>主题</span></h2>
			</div>
      <div class="conFaTie">
        <form action="index.php?a=add" method="post">
        <div class="conFaTieLei">
          <select id="inputOp" name="book" class="conFaTieLei1" >
        ...
        <div class="conFaTieTitle">
          <input type="text" name="bbs_title" placeholder="标题……" value="<?php echo nl2br($details['bbs_title']) ?>">
        </div>
        <div class="conFaTieTxt">
            <img src="../static/shuru.png" alt="">
              <textarea name="bbs_content" id="" cols="30" rows="10" placeholder="请输入你想要发布的内容">
